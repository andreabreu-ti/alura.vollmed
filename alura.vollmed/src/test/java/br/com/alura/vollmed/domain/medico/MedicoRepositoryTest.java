...
import br.com.alura.vollmed.domain.consulta.Consulta;
...
class MedicoRepositoryTest {
	...
	void escolherMedicoAleatorioLivreNaDataCenario1() {
		...
		var proximaSegundaAs10 = LocalDate.now()
				...
				.atTime(10,0);
		var medico = cadastrarMedico("Medico", "medico@java.com", "666154", Especialidade.CARDIOLOGIA);
		var paciente = cadastrarPaciente("Paciente", "paciente@java.com", "12365478996");
