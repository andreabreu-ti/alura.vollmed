...
class MedicoRepositoryTest {
	...
	void testEscolherMedicoAleatorioLivreNaDataCenario1() {
		...
		var medico = cadastrarMedico("Medico", "medico@voll.com", "234567", Especialidade.CARDIOLOGIA);
		var paciente = cadastrarPaciente("Paciente", "paciente@email.com", "65465465465");
