...
public class SpringDocConfigurations {
	...
	/*
	 * Para saber mais detalhes sobre quais informações podem ser configuradas na documentação da API, 
	 * consulte a especificação OpenAPI no site oficial da iniciativa.
	 * 
